    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary relative items-center justify-center p-12">
        ...
        <div className="relative z-10 text-white space-y-6 max-w-md">
          ...
          <h1 className="text-4xl font-bold leading-tight">Neware Khaja Ghar</h1>
          <p className="text-lg text-white/80 leading-relaxed">
            Manage your guest house operations with ease. Track bookings, bills, orders, and customers all in one place.
          </p>
          <div className="flex gap-8 pt-4">
            {[["10+", "Rooms"], ["500+", "Guests"], ["24/7", "Service"]].map(([v, l], i) => (
              <div key={i}>
      ...
      <div className="flex-1 flex items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-sm space-y-8">
          ...
          <div className="rounded-xl bg-muted/50 p-4 space-y-2 text-xs text-muted-foreground">
            ...
            <p>Admin: admin@neware.com / admin123</p>
            <p>Customer: ram@example.com / customer123</p>
          </div>
        </div>
      </div>
    </div>
